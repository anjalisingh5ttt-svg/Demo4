  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        {(categoryData.featureImage?.asset?.url ||
          categoryData.featureVideo?.asset?.url) && (
          <motion.div
          ...
          >
            {categoryData.featureVideo?.asset?.url ? (
              <video
                src={categoryData.featureVideo.asset.url}
                autoPlay
                muted
                loop
                playsInline
              ...
              <Image
                src={categoryData.featureImage.asset.url}
          ...
          {categoryData.products.map((item, index) => (
            ...
            >
              <ProductCard
                ...
                image={item.mainImage?.asset?.url || "/placeholder.jpg"}
